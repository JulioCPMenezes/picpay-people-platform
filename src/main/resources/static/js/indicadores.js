...
const totalCandidatosElemento =
    document.getElementById(
        "totalCandidatos"
    );

const totalEmAnaliseElemento =
    document.getElementById(
        "totalEmAnalise"
    );

const totalAprovadosElemento =
    document.getElementById(
        "totalAprovados"
    );

const totalReprovadosElemento =
    document.getElementById(
        "totalReprovados"
    );

const totalContratadosElemento =
    document.getElementById(
        "totalContratados"
    );
...
const legendaAprovados =
    document.getElementById(
        "legendaAprovados"
    );

const legendaReprovados =
    document.getElementById(
        "legendaReprovados"
    );

const legendaContratados =
    document.getElementById(
        "legendaContratados"
    );
...
botaoPerfil.addEventListener(
    ...
    event => {
        ...
        perfilContainer.classList.toggle(
            "aberto"
        );
...
function calcularMediaSalarialPorDepartamento(
    candidatos
) {
    const departamentos = {};
...
window.definirIndicadores =
    definirIndicadores;

window.definirUsuario =
    usuario => {
